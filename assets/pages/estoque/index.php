...
<body>
  ...
  <div class="container d-flex mx-auto">
    <div class="container_geral mx-2 mt-4">
      ...
      <div class="mt-5 mx-3">
        <?php require_once("../../php/estoque/generateTable.php") ?>
      </div>
      <div class="d-flex gap-2 pb-3 w-100 justify-content-start mt-3 mb-3 container botao_mobile">
        <a class="botao_submit pt-2 pb-2 ms-2" href="entrada-produto.php" data-toggle="tooltip" data-placement="top" title="Movimentar Produtos">
          <img src="../../icones/movimentar-produtos.svg" alt="movimentar-produtos.svg">Movimentar Produtos</a>
    
        <a class="botao_submit pt-2 pb-2 ms-2" href="relatorio-estoque.php" data-toggle="tooltip" data-placement="top" title="Relatório">
          <img src="../../icones/relatorio.svg" alt="relatorio.svg">Relatório</a>
